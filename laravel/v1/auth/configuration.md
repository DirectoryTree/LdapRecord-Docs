...
> Be sure to add the required [trait and interface](/docs/laravel/v1/laravel/auth/installation) to this model as shown in the installation guide.
...
being [imported](/docs/laravel/v1/laravel/auth/importing), you can create an attribute handler class
