...
the [Directory Emulator](/docs/laravel/v2/laravel/testing#directory-emulator). Using it, we can
test authentication [rules](/docs/laravel/v2/laravel/auth/configuration#rules),
...
If your application has [password synchronization](/docs/laravel/v2/laravel/auth/configuration/#database)
