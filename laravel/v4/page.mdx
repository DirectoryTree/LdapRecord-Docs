...
It uses the core [LdapRecord](/docs/core/v4) package under the hood, so be sure to look at its
[documentation](/docs/core/v4), so you have an understanding of how everything works.
...
If you require immediate support, consider becoming a [sponsor](https://github.com/DirectoryTree/LdapRecord?sponsor=1)
