...
Be sure to review the core [LdapRecord documentation](/docs/core/v4) as it explains
...
[built-in models](/docs/core/v4/models#predefined-models) to get up and running right away.
...
To begin querying your model, you can statically call [query methods](/docs/core/v4/searching) off of the model:
...
[user management tutorial](/docs/laravel/v4/active-directory/users/).
</Note>
...
<Note>
Be sure to take a peek at the [model scopes](/docs/core/v4/model-scopes/)
...
[connection container](/docs/core/v4/connections/#container).
