...
view [this guide](/docs/laravel/v4/auth/database/importing) instead.
</Note>
...
As with [importing LDAP users](/docs/laravel/v4/auth/database/importing), you may also use an [attribute handler](/docs/laravel/v4/auth/database/configuration/#attribute-handlers)
