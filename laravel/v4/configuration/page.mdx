...
<Important>
It's recommended to only use one approach listed in this guide below. Using
...
<Note>
Review the [LDAP configuration documentation](/docs/core/v4/configuration) to see what each option is used for.
</Note>
