...
[Plain Authentication Overview](/docs/laravel/v4/auth/plain/)
...
[Synchronized Database Authentication Overview](/docs/laravel/v4/auth/database/)
...
<Important>
A base DN must still be configured for searches to return results.
</Important>
