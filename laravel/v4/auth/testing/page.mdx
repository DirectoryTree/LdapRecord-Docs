...
the [Directory Emulator](/docs/laravel/v4/testing#directory-emulator). Using it, we can test authentication rules,
[scopes](/docs/laravel/v4/models#query-scopes), and group memberships.
...
If your application has [password synchronization](/docs/laravel/v4/auth/database/configuration#sync-passwords)
