...
authentication providers you configure with [database synchronization](/docs/laravel/v4/auth/database).
...
Be sure to look at the [documentation](/docs/laravel/v4/auth/database/configuration#database-sync-attributes)
...
Be sure to look at the [documentation](/docs/laravel/v4/auth/database/configuration#database-sync-existing)
to get a further understanding on what is possible with this option.
...
<Note>
It's recommended to use [model query scopes](/docs/core/v4/models#query-scopes) instead of the `--filter`
...
To execute the import command, you **must** supply an [authentication provider](/docs/laravel/v4/auth/database/configuration)
...
[OnlyImported](/docs/laravel/v4/auth/restricting-login/#using-only-manually-imported-users)
...
[authentication provider](/docs/laravel/v4/auth/database/configuration#sync-attributes).
</Important>
