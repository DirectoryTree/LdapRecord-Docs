...
<Important>
Before we begin, it's paramount to understand that LdapRecord does not support credentialess 
...
see the [configuration guide](/docs/laravel/v4/configuration) for more information.
</Important>

Once you have [configured a new authentication provider](/docs/laravel/v4/auth/database/configuration),
...
<Important>
Keep in mind you will have to alter your `sync_attributes` inside your `config/auth.php`
