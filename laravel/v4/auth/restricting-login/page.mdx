...
allow sign in to your application, we will leverage LdapRecord [model scopes](/docs/core/v4/models#query-scopes).
...
If you are using one of the [built-in predefined models](/docs/core/v4/models#predefined-models), you
...
To enforce only [manually imported LDAP users](/docs/laravel/v4/importing) who exist inside your
