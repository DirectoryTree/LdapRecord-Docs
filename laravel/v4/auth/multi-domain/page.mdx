...
<Note>
You may want these models to extend the [built-in models](/docs/core/v4/models/#predefined-models), as they
...
For each of our LDAP connections, we will set up new [authentication providers](/docs/laravel/v4/auth),
