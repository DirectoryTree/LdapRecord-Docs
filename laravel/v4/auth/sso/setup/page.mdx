...
[setting up multi-domain authentication](/docs/laravel/v4/auth/multi-domain/).
...
<Important>
When guarding your routes that require authentication via the
...
<Important>
This is a security issue if you use multi-domain authentication,
...
<Important>
Only enable this feature if Single-Sign-On is the only way
