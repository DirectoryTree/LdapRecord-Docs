...
- A new [`min-users` command option](/docs/laravel/v4/auth/database/importing#min-users)
...
- A new [`scopes` configuration option](/docs/laravel/v4/auth/database/configuration#scopes) 
