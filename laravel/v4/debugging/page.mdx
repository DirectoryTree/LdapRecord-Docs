...
This process is fully documented on the [configuration](/docs/core/v4/configuration#ssl-amp-tls)
...
3. Add the `ListensForLdapBindFailure` trait onto your `LoginController` (see the [Laravel UI auth guide](/docs/laravel/v4/auth/database/laravel-ui#displaying-ldap-error-messages) for details)
