...
the default `LoginController` that is included with the [Laravel UI package](https://laravel.com/docs/laravel/v2/authentication#introduction).
...
If you are using [database synchronization](/docs/laravel/v2/laravel/auth#database), model binding allows
