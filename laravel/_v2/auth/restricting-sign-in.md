...
To allow only [manually imported LDAP users](/docs/laravel/v2/laravel/importing) who exist inside of your
database to sign in to your application, you must create an [authentication rule](/docs/laravel/v2/laravel/auth/configuration#rules).
...
allow sign in to your application, we will leverage LdapRecord [model scopes](/docs/laravel/v2/models#query-scopes).
...
If you are using one of the [built-in predefined models](/docs/laravel/v2/models#predefined-models), you 
...
will use an [authentication rule](/docs/laravel/v2/laravel/auth/configuration#rules).
