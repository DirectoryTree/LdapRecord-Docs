...
This new provider must have its own unique `model` class set which must use your [alternate configured connection](/docs/laravel/v2/models#connections)
...
The `model` option must be the class name of your [LdapRecord model](/docs/laravel/v2/models). This model will be used
