...
[built-in models](/docs/laravel/v2/models#predefined-models) to get up and running right away.
...
To begin querying your model, you can statically call [query methods](/docs/laravel/v2/searching) off of the model:
...
> Be sure to take a peek at the [query scopes](/docs/laravel/v2/models#query-scopes)
...
[connection container](/docs/laravel/v2/connections/#container).
