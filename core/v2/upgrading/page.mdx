...
<Important>
These methods now return no value (`void`).
</Important>
...
<Important>
These methods maintain their return value from v1.
</Important>
...
<Important>
This means that Object GUID's are no longer available immediately after creation.
</Important>
