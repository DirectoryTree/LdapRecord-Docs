...
<Note>
Before getting started, ensure you've added at least one connection to the [container](/docs/core/v4/connections#container).
</Note>
...
<Important>
Make sure you import the classes with the exact casing
...
[container](/docs/core/v4/connections#container). To set your model to use an alternate connection,
...
<Important>
When changing connections, be sure that the
...
[query builder](/docs/core/v4/searching) methods so you can utilize
...
<Note>
We're using [base DN substitution](/docs/core/v4/searching/#automatic-base-dn-substitution) 
...
<Important>
This feature is only possible when connecting to an Active Directory server.
</Important>
...
LdapRecord models fire several different [events](/docs/core/v4/events) during the creation,
