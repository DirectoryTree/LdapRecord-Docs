...
in an array. You must query using [models](/docs/core/v4/models#retrieving-models)
...
<Important>
The operators "greater than (&gt;)" or "less than (&lt;)" are not supported in LDAP.
...
Now that you know how to search your directory, lets move onto [creating / modifying LDAP objects](/docs/core/v4/models).
