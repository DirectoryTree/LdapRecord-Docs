...
```php
// Returns \LdapRecord\Query\EscapedValue;
...
<Important>
If a mutator exists for the attribute (such as a date,
or custom attribute [mutator method](//docs/core/v4/model-mutators/#defining-a-mutator)),
...
<Important>
Calling `inside()` on an existing model will not perform any
...
<Important>
When renaming is successful, the models distinguished name is
...
<Important>
The [save](#save) method should be used instead
