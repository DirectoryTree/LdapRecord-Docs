...
<Important>
The model query builder extends the base query builder. 

All of [its methods](/docs/core/v4/searching-api) are available on model queries.
</Important>
## Method Listing
...
<Important>
If your LDAP server does not support ANR, an equivalent filter will be generated automatically.
</Important>
```php
